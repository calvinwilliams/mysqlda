...
/*
./mysqlda_test_select_library "192.168.6.21" 13306 calvin calvin calvindb 1 1000
*/

static void usage()
{
	printf( "USAGE : mysqlda_test_select_library (ip) (port) (user) (pass) (database) (begin_seqno) (end_seqno)\n" );
	return;
}
