...
#ifndef _H_mysqlda_conf_
#define _H_mysqlda_conf_
...
_WINDLL_FUNC int DSCSERIALIZE_JSON_mysqlda_conf( mysqlda_conf *pst , char *encoding , char *buf , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_JSON_DUP_mysqlda_conf( mysqlda_conf *pst , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_JSON_DUP_mysqlda_conf_V( void *pv , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_mysqlda_conf( char *encoding , char *buf , int *p_len , mysqlda_conf *pst );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_mysqlda_conf_V( char *encoding , char *buf , int *p_len , void *pv );
